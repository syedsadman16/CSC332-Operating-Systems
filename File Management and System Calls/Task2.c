...
be opened(i.e.the file doesn’t have read permission).You are to use ​open()​,​read()​,​write()​,andclose() ​system calls. */
...
int main(int argc, char *argv[]){
    ...
    // Check if file has read access, returns 0 if true
